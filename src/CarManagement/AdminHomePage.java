...
public class AdminHomePage extends JFrame implements ActionListener {
    ...
    AdminHomePage(){
        ...
        ImageIcon img = new ImageIcon(Signup_User.class.getResource("Icons/admin_homepage.jpg"));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (command.equals("Update User Details")){
    
            new UpdateUserDetails().setVisible(true);
        }
        else if(command.equals("View User Profile")){
        ...
        else if(command.equals("Add New Brand")){
            new AddNewBrand();
        }
        else if(command.equals("View Brand")){
            new ViewBrand().setVisible(true);
        }
        else if(command.equals("Add New Car")){
